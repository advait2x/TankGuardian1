...
const features = [
  {
    ...
    description:
      "Never forget a water change or feeding. Auto-generated schedules for your tank.",
  },
  {
    icon: <Shield size={28} color="#0D7377" />,
    title: "Compatibility Checks",
    description:
      "Know before you add. Prevent aggression and overstocking disasters.",
  },
  {
    icon: <Search size={28} color="#0D7377" />,
    title: "Disease Detection",
    description:
      "Upload a photo and get instant analysis with treatment steps.",
  },
  {
    icon: <Users size={28} color="#0D7377" />,
    title: "Community",
    description:
      "Connect with hobbyists, share your tanks, and learn from experts.",
  },
];
...
export default function LandingScreen() {
  ...
  useEffect(() => {
    ...
    showMascot(
      "guide",
      "mid-right",
      "Hey! Ready to keep your fish happy?",
      2500,
    );
    return () => {
      hideMascot();
      ...
      <SafeAreaView style={styles.safeArea}>
        ...
        >
          ...
          >
            ...
            >
              Your pocket aquarium assistant that guides you through setup,
              reminds you of tasks, and helps diagnose problems.
            </Animated.Text>
          </Animated.View>
          ...
          <Text style={styles.footer}>
            Join the community of aquarium enthusiasts who never lose another
            fish.
          </Text>
        </ScrollView>
      </SafeAreaView>
